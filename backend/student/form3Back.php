<?php
    ...
    if(isset($_POST["fbtn"])){
        $query = "SELECT std_rollno FROM qualidetail WHERE std_rollno = '$rollno';";
        $result = mysqli_query($conn, $query);
        $rowcount = mysqli_num_rows($result);   
    }
    if($rowcount == 1) {
        $q1 = "UPDATE qualidetail SET sscdate = '$sscdate', sscyear = '$sscyear' WHERE std_rollno = '$rollno';";
        mysqli_query($conn, $q1);
        header("location:form3.php?fbtn=success");
    }else {
        $q2 = "INSERT INTO qualidetail (std_rollno, sscdate, sscyear) VALUES ('$rollno', '$sscdate', '$sscyear');";
    ...
    if (isset($_POST["sem1btn"])) {
        ...
        if (empty($rollnoo) == false) {
            $q3 = "UPDATE qualidetail SET sem1attd = '$sem1attd', sem1date = '$sem1date', sem1sub = '$sem1sub' WHERE std_rollno = '$rollnoo';";
    ...
    if (isset($_POST["sem2btn"])) {
        ...
        if (empty($rollnoo) == false) {
            $q4 = "UPDATE qualidetail SET sem2attd = '$sem2attd', sem2date = '$sem2date', sem2sub = '$sem2sub' WHERE std_rollno = '$rollnoo';";
    ...
    if (isset($_POST["sem3btn"])) {
        ...
        if (empty($rollnoo) == false) {
            $q5 = "UPDATE qualidetail SET sem3attd = '$sem3attd', sem3date = '$sem3date', sem3sub = '$sem3sub' WHERE std_rollno = '$rollnoo';";
    ...
    if (isset($_POST["sem4btn"])) {
        ...
        if (empty($rollnoo) == false) {
            $q6 = "UPDATE qualidetail SET sem4attd = '$sem4attd', sem4date = '$sem4date', sem4sub = '$sem4sub' WHERE std_rollno = '$rollnoo';";
    ...
    if (isset($_POST["sem5btn"])) {
        ...
        if (empty($rollnoo) == false) {
            $q7 = "UPDATE qualidetail SET sem5attd = '$sem5attd', sem5date = '$sem5date', sem5sub = '$sem5sub' WHERE std_rollno = '$rollnoo';";
    ...
    if (isset($_POST["sem6btn"])) {
        ...
        if (empty($rollnoo) == false) {
            $q8 = "UPDATE qualidetail SET sem6attd = '$sem6attd', sem6date = '$sem6date', sem6sub = '$sem6sub' WHERE std_rollno = '$rollnoo';";
    ...
    if (isset($_POST["sem7btn"])) {
        ...
        if (empty($rollnoo) == false) {
            $q9 = "UPDATE qualidetail SET sem7attd = '$sem7attd', sem7date = '$sem7date', sem7sub = '$sem7sub' WHERE std_rollno = '$rollnoo';";
    ...
    if (isset($_POST["sem8btn"])) {
        ...
        if (empty($rollnoo) == false) {
            $q10 = "UPDATE qualidetail SET sem8attd = '$sem8attd', sem8date = '$sem8date', sem8sub = '$sem8sub' WHERE std_rollno = '$rollnoo';";
