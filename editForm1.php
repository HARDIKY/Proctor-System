...
<?php 
  ...
  while($row = mysqli_fetch_array($result))
    {
  ?>
  <form action="editForm1Back.php" method="POST" enctype="multipart/form-data">
  <br />
...
<!-- ==========Personal Information========================================================================================= -->
  ...
  <br>
  &nbsp; <input type="submit" name="editForm1" value="Submit" class="btn btn-dark"> &nbsp; &nbsp;
  <input type="submit" name="mkpdf1" value="Download pdf" class="btn btn-dark"><br><br>
