...
?>
    ...
    <div class="container mt-3">
      ...
      <?php 
        ...
        {
            ?>
      <form action="editForm2Back.php" method="POST" enctype="multipart/form-data">
...
<!-- finish line -->
  <hr>
  <br>
    &nbsp; <input type="submit" name="editForm2" value="Submit" class="btn btn-dark"> &nbsp; &nbsp;
    <input type="submit" name="mkpdf2" value="Download pdf" class="btn btn-dark"><br><br>
    &nbsp; <a href="editForm3.php" class="btn btn-dark">Next Form</a>  &nbsp; &nbsp;
