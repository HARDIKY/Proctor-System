...
<html lang="en">
  ...
  ?>
    ...
    <div class="container mt-3">
      ...
      <ul class="b">
        <li><p class="lead">ID-Card No : <?php echo $_SESSION['roll']?> </p></li>
      </ul>
      <hr class="my-4">
      <br />
      <?php 
      ...
      <form action="editForm3Back.php" method="POST" enctype="multipart/form-data">
        ...
        <br>
        <br>
        &nbsp; <input type="submit" name="editForm3" value="Submit" class="btn btn-dark"> &nbsp; &nbsp;
        <input type="submit" name="mkpdf3" value="Download pdf" class="btn btn-dark"><br><br>
        &nbsp; <a href="editForm4.php" class="btn btn-dark">Next Form</a> &nbsp; &nbsp;
        <a href="sHome.php" class="btn btn-dark">Go Home</a>
        <?php
            }
        ?>
      </form>
