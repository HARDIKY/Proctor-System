<?php
        ...
        if (!in_array($extension, ['pdf'])) {
            ...
            if (move_uploaded_file($file, $destination)) {
                ...
                if (mysqli_query($conn, $sql)) {
                    header("location:editForm3.php?upload=success");
                }
            }else {
                header("location:editForm3.php?upload=notsuccess");
            }
        }
        // Leaving Upload==============================
    ...
    header("location:editForm3.php?form3=updated");
    ...
    header("location:editForm3.php?form3=completed");
